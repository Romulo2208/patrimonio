  ...
  <div class="span12">
    <div class="tabbable">
      <ul class="nav nav-tabs" id="myTab">
          <li class="active"> <?php echo $this->Html->link(__('<i class="blue icon-folder-open bigger-110"></i> Produto'), array('controller' => 'materiais', 'action' => 'index'), array('class' => '', 'escape' => false)); ?> </li>
          <li> <?php echo $this->Html->link(__("<i class='green icon-bullhorn bigger-110'></i> Estoque Minimo <span class='badge badge-important'></span>"), array('controller' => 'materiais', 'action' => 'estoque_minimo'), array('class' => '', 'escape' => false)); ?></li>
      ...
      <div class="tab-content">
        <div class="tab-pane in active">
          <p>
            <?php if(!in_array($this->Session->read('Perfil.id'), array('2', '3','12'))) { ?>
            <?php echo $this->Html->link(__(' Novo Produto'), array('action' => 'add'), array('class' => 'btn btn-small btn-inverse icon-edit bigger-110 popup', 'style' => '')); ?>
            <?php } ?><br><br>
            <?php if(!in_array($this->Session->read('Perfil.id'), array('12'))) { ?>
            <?php echo $this->Html->link(__(' Saldo Diesel S-10'), array('action' => 'saldo_anterior'), array('class' => 'btn btn-small btn-inverse icon-edit bigger-110 popup', 'style' => '')); ?>
            <?php } ?>
          ...
          <table class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th><?php echo $this->Paginator->sort('Prateleira'); ?></th>
            ...
            <tbody>
              <?php foreach ($materiais as $material): ?>
                <tr>
                  ...
                  <td><?php echo h($material['MaterialFilial']['prateleira']); ?>&nbsp;</td>
                  ...
                  <?php //} ?>
                    <?php if(!in_array($this->Session->read('Perfil.id'), array('2', '3','12'))) { ?>
                      <a href="<?php echo $this->Html->url(array('action' => 'etiqueta', $material['Material']['id']), true); ?>" class="btn btn-mini btn-light" data-rel="doc" target="blank"><i class="icon-file bigger-110"></i> Etiqueta</a>
                  <?php } ?>
                  </td>
                </tr>
              <?php endforeach; ?>
