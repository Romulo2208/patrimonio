<div class="widget-box">
  ...
  <div class="widget-body" style="width: 1100px; height: 500px">
        ...
        <div class="input-prepend">
          ...
          <div class="controls">
            ...
            <?php if(in_array($this->Session->read('Perfil.id'), array('2', '3'))) { ?>
              <?php echo $this->Form->input('classificacoes_id', array('type' => 'select', 'label' => false, 'div' => false, 'class' => 'input-xxlarge', 'required' => true, 'empty' => true, 'options' => $classificacoes, 'disabled' => true)); ?>
            <?php }else{ ?>
                <?php echo $this->Form->input('classificacoes_id', array('type' => 'select', 'label' => false, 'div' => false, 'class' => 'input-xxlarge', 'required' => true, 'empty' => true, 'options' => $classificacoes, 'disabled' => false)); ?>
            <?php } ?>
          </div>
        </div>
      </p>
      ...
      <p>
        <div class="input-prepend">
          ...
          <div class="controls">
            ...
            <?php if(in_array($this->Session->read('Perfil.id'), array('2','3'))) { ?>
              <?php echo $this->Form->input('quantidade', array('label' => false, 'div' => false, 'class' => 'input-small', 'required' => true, 'value' => $filiais['MaterialFilial']['quantidade'], 'readonly' => true)); ?>
          <?php }else{ ?>
      ...
      <p>
        <div class="input-prepend">
          ...
          <div class="controls">
            ...
            <?php if(in_array($this->Session->read('Perfil.id'), array('2', '3'))) { ?>
              <?php echo $this->Form->input('est_min', array('label' => false, 'div' => false, 'class' => 'input-small', 'required' => true, 'value' => $filiais['MaterialFilial']['est_min'], 'readonly' => true)); ?>
            <?php }else{ ?>
