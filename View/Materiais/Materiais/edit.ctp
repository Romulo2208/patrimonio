     ...
     <!-- <p>
      ...
      <p>
        <div class="input-prepend">
          ...
          <div class="controls">
            ...
            <?php echo $this->Form->input('classificacoes_id', array('type' => 'select', 'label' => false, 'div' => false, 'class' => 'input-large', 'required' => true, 'empty' => true, 'options' => $classificacoes, 'disabled' => true)); ?>
          </div>
        </div>
      </p>
      ...
      <p>
        <div class="input-prepend">
          ...
          <div class="controls">
            ...
            <input type="text" name="Material[barcode]" class="input-large" value="<?php echo $itens[0]['Material']['barcode']; ?>" <?php if(in_array($this->Session->read('Perfil.id'), array('2', '3'))) { ?> readonly <?php } ?>/>
          </div>
        </div>
      </p>
      ...
      <p>
        <div class="input-prepend">
          ...
          <div class="controls">
            <?php echo $this->Form->input('descricao', array('label' => false, 'div' => false, 'class' => 'input-xxlarge', 'required' => false, 'value' => $filiais['MaterialFilial']['descricao'])); ?>
          </div>
        </div>
      </p>
