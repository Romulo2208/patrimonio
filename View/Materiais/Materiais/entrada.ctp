              ...
              <p>
                <div class="row-fluid">
                  ...
                  <div class="controls">
                    ...
                    <?php echo $this->Form->input('materiais_id', array('label' => false, 'div' => false, 'empty'=>true,  'class' => 'chzn-select', 'data-placeholder' => 'Selecione o produto', 'style'=>'width: 295px;', 'required' => true)); ?>
