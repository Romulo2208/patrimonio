              ...
              <p>
                <div class="row-fluid">
                  ...
                  <div class="controls">
                    ...
                    <?php echo $this->Form->input('materiais_id', array('label' => false, 'div' => false, 'type'=>'select', 'empty'=>true,  'class' => 'chzn-select', 'data-placeholder' => 'Selecione o produto', 'style'=>'width: 295px;','required' => true)); ?>
              ...
              <p>
                <div class="input-prepend">
                  ...
                  <div class="controls">
                    ...
                    <?php echo $this->Form->input('aplicacao', array('label' => false, 'div' => false, 'type'=>'text', 'empty'=>true,  'class' => 'input-xlarge', 'required' => true)); ?>
                  </div>
                </div>
              </p>
