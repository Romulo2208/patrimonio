<div class="widget-box">
  ...
  <div class="widget-body">
    <div class="widget-main">
      ...
      ?>
      <?php foreach ($carregamentos as $id => $carregamento) { ?>
        <div class="control-group">
          ...
          <span class="input-icon input-icon-right">
            <input type="text" name="Carregamento[placa]" class="input-small" min="0" value="<?php echo $carregamento['Carregamento']['placa']; ?>"/>
          </span>
        </div>
            ...
            <span class="input-icon">
              <select name="Carregamento[produtos_id]" class="chzn-select" style="width: 0px" data-placeholder = "Selecione o produto" onchange="getDescricao(this);">
                ...
                foreach ($produtos as $key => $value) {
                  $selected = $key == $this->request->data['Carregamento']['produtos_id'] ? 'selected' : null;
          ...
          <div class="control-group">
            ...
            <span class="input-icon input-icon-right">
              <input type="text" name="Carregamento[quantidade]" class="input-mini" min="0" value="<?php echo $carregamento['Carregamento']['quantidade']; ?>" oninput="maskReal(this)"
/>
            </span>
          </div>
