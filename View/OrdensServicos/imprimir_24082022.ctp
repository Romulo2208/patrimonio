...
$html .= "<td><font size='3'><b>r&#36; {$preco}</b></font></td>";
$html .= "</tr>";
$html .= "</thead>";
$html .= "</table>";
...
$precopecatotal = number_format($totalpeca[0][0]['Total'],2,",",".");
$html .= "<tr>";
$html .= "<td></td>";
$html .= "<td style='text-align: right;'><font size='2'><b>TOTAL:</font></b></td>";
...
$html .= "<br>";
$html .= "<p align='left'><b>Conclus&atilde;o:</b><font size='1'>{$ordem['OrdemServico']['conclusao']}</font></p>";
$html .= "<br><br>";
...
if($assinatura[0]['b']['nome'] <>''){
  $html .= "<p align='center'><font size='1'>{$assinatura[0]['b']['nome']}<br>{$dataAssinatura}</font><br><b>_________________________</b></p>";
  $html .= "<p align='center'><font size='1'><b>       GERENTE FILIAL</b></font></p>";
// $html .= "<p align='center'><font size='1'>{$assinatura[0]['b']['nome']}<br>{$data}</font></p>";
}else{
...
$html .= "<p align='center'><font size='1'><b>       EXECULTADO POR</b></font></p>";
$html .= "</div>";
$html .= "</div>";
