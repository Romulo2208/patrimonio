<div class="widget-box">
  ...
  <div class="widget-body">
    <div class="widget-main">
      <?php
      echo $this->Form->create('ServicoPeca', array('class' => 'form-horizontal'));
      ...
      <span class="materiais" >
        ...
        <div class="row-fluid" style="margin-top: 10px;">
          ...
          <div class="input-prepend">
            ...
            <span class="input-icon">
              <input type="text" name="peca[quantidade][]" class="input-mini" min="0" onkeypress="maskReal(this);" value="<?php echo $peca['ServicoPeca']['quantidade']; ?>"/>
            </span>
          </div>

          <div class="input-prepend">
            <label>Pe&ccedil;as e Acessorios</label>
            <span class="add-on">
              <i class="icon-plus"></i>
            </span>
            <span class="input-icon">
              <input type="text" name="peca[pecas_acessorios][]" class="input-xlarge" min="0" value="<?php echo $peca['ServicoPeca']['pecas_acessorios']; ?>"/>
            </span>
          </div>
          ...
          <div class="input-prepend">
            ...
            <span class="input-icon">
              <input type="text" name="peca[precos][]" class="input-small" min="0" onkeypress="maskReal(this);" value="<?php echo $peca['ServicoPeca']['precos']; ?>"/>
            </span>
          </div>
        ...
        <input type="hidden" name="ServicoPeca[id]" class="input-small" min="0" value="<?php echo $peca['ServicoPeca']['id']; ?>"/>
        <input type="hidden" name="ServicoPeca[ordens_servicos_id]" class="input-small" min="0" value="<?php echo $peca['ServicoPeca']['ordens_servicos_id']; ?>"/>
        <?php } ?>
      </span>
      ...
      <!-- <div class="row-fluid" style="margin-top: 10px;">
        <div class="input-prepend">
          ...
          <input type="textarea" name="peca[conclusao][]" class="input-xlarge" min="0" value="<?php //echo $peca['ServicoPeca']['conclusao']; ?>"/>
