...
<div class="row-fluid" style="margin-top: 10px;">
  <div class="input-prepend">
    <label>Conclus&atilde;o / Prazo para pagamento </label>
...
<div class="input-prepend">
  <label>Desconto Pecas</label>
  <span class="add-on">
    <i class="icon-plus"></i>
  </span>
  <span class="input-icon">
    <input type="text" name="OrdemServico[desconto_peca]" class="input-mini" min="0" onkeypress="maskReal(this);" value="<?php echo $servicos[0]['OrdemServico']['desconto_peca']; ?>" />
  </span>
</div>

<div class="input-prepend">
  <label>Desconto Servico</label>
  <span class="add-on">
    <i class="icon-plus"></i>
  </span>
  <span class="input-icon">
    <input type="text" name="OrdemServico[desconto_servico]" class="input-mini" min="0" onkeypress="maskReal(this);"  value="<?php echo $servicos[0]['OrdemServico']['desconto_servico']; ?>" />
  </span>
</div>
