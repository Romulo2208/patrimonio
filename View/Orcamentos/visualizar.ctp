                  ...
                  <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                          <?php foreach ($orcamentos as $orcamento) { ?>
                            <tr>
                                <td><?php echo $orcamento['Setor']['descricao']; ?></td>
                                <td><?php echo $orcamento['ItemOrcamento']['pedidos_id']; ?></td>
                                <td style="text-align: center;">
                                  ...
                                  <a href="<?php echo $this->Html->url(array('action' => 'transferencia', $orcamento['ItemOrcamento']['pedidos_id']), true); ?>" class="btn btn-mini btn-info popup" data-rel="doc"><i class="icon-edit bigger-110"></i> Transferencia</a>
                                </td>
                            </tr>
                          <?php } ?>
                      </tbody>
