                ...
                <?php if(sizeof($itens)){ ?>
                  <?php foreach ($itens as $value) { ?>
                    <option
                      ...
                      data-quantidade_transferida="<?php echo $value['ItemOrcamento']['quantidade']; ?>"
                      ...
                      ><?php echo $value['Material']['barcode']. ' - ' .$value['Material']['nome'] ; ?></option>
                  <?php }} ?>
              </select>
  ...
  $(function () {
    $('#add_item').click(function() {
      ...
      $.each(associados, function( index, value ) {
        $.post('/patrimonio/orcamentos/transferencia_filial/', {
    ...
    $('#remove_item').click(function() {
      ...
      $.each(associados, function( index, value ) {
        $.post('/patrimonio/orcamentos/delete_transferencia/', {
