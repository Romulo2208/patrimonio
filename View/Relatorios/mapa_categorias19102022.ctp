  ...
  <tbody>
    ...
    <?php foreach ($materiais as $material): ?>
      <tr>
        ...
        <td><?php echo h($material['a']['quantidade_central'] + $material[0]['Filial1']+$material[0]['Filial2']+$material[0]['Filial4']+$material[0]['Filial9']+$material[0]['Emfol']+$material[0]['Calta']+$material[0]['Americal']); ?>&nbsp;</td>
      </tr>
    <?php endforeach; ?>
  <?php } ?>
  </tbody>
