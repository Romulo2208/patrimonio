    ...
    <div class="widget-main">
      ...
      <div class="row-fluid">
          <div class="input-prepend">
            ...
            <select name="data[Transferencia][setores_id]" class="input-xlarge select" onchange="getDescricao(this);">
              <?php
        ...
        <div class="row-fluid" style="margin-top: 10px;">
          ...
          <!-- <div class="input-prepend">
            ...
            <span class="input-icon input-icon-right">
              <input type="text" name="material[aplicacao][]" class="input-small" min="0" />
            </span>
          </div> -->
          ...
          <div class="input-prepend">
            ...
            <span class="input-icon input-icon-right">
              <input type="number" name="material[transferencia][]" class="input-mini" min="0" />
            </span>
          </div>
