<div class="widget-box">
  <div class="widget-header">
    <h4>NOVA REQUISI&Ccedil;&Atilde;O</h4>
    ...
    <div class="widget-main">
      ...
      <div class="row-fluid">
          <div class="input-prepend">
            ...
            <select name="data[Compra][setores_id]" class="input-xlarge select" onchange="getDescricao(this);">
          ...
          <div class="input-prepend">
              ...
              <?php echo $this->Form->input('situacao', array('label' => false, 'div' => false, 'type' => 'select', 'options' => array('1'=>'Pendente','3'=>'Em andamento','2'=>'Atendido'), 'required' => true, 'class' => 'input-medium')); ?>
          </div>
      </div>
        ...
        <div class="row-fluid" style="margin-top: 10px;">
          <div class="input-prepend">
            ...
            <span class="input-icon">
              <select name="material[id][]" class="input-large select" onchange="getDescricao(this);">
                <option value='0'></option>
                <?php
          ...
          <div class="input-prepend">
            ...
            <span class="input-icon input-icon-right">
              <input type="text" name="material[aplicacao][]" class="input-medium" min="0" />
            </span>
          </div>
          ...
          <div class="input-prepend">
            ...
            <span class="input-icon input-icon-right">
              <input type="number" name="material[compra][]" class="input-mini" min="0" />
            </span>
          </div>
