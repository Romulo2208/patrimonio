                      ...
                      <tbody>
                          <?php foreach ($compras as $compra) { ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><?php echo ($compra['Compra']['situacao'] == 1 ? "<span class='icon-edit red bigger-160' title='Pendente'></span>" : "<span class='icon-check green bigger-160' title='Atendido'></span>"); ?></td>
